...
public class AllItems {
    ...
    public static final ItemEntry<AspectOfTheVoidItem> ASPECT_OF_THE_VOID = REGISTRATE.item("aspect_of_the_void",
            ...
            .register();
    public static final ItemEntry<TerminatorItem> TERMINATOR = REGISTRATE.item("terminator",
                    TerminatorItem::new)
            .properties(p -> p.durability(1000))
            .tab(AllTabs.HYPERION.getKey(), TerminatorItem::addToTab)
            .onRegisterAfter(Registries.ITEM, addTooltip(""))
            .register();
    public static final ItemEntry<DungeonMapItem> DUNGEON_MAP = REGISTRATE.item("dungeon_map",
                    DungeonMapItem::new)
            .model((ctx, output) -> output.generated(ctx::get, mc("item/filled_map")))
            .register();

    public static final ItemEntry<Item> ENCHANTED_ENDER_PEARL = REGISTRATE.item("enchanted_ender_pearl",
                    Item::new)
            ...
            .register();
    public static final ItemEntry<Item> ABSOLUTE_ENDER_PEARL = REGISTRATE.item("absolute_ender_pearl",
                    Item::new)
            .register();
    public static final ItemEntry<Item> TESSELLATED_ENDER_PEARL = REGISTRATE.item("tessellated_ender_pearl",
                    Item::new)
            .register();

    public static final ItemEntry<Item> ENCHANTED_LAPIS_LAZULI = REGISTRATE.item("enchanted_lapis_lazuli",
                    Item::new)
            .properties(p -> p.component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true))
            .model((ctx, output) -> output.generated(ctx::get, mc("item/lapis_lazuli")))
            .register();

    public static final ItemEntry<Item> JUDGEMENT_CORE = REGISTRATE.item("judgement_core",
                    Item::new)
            .register();
    ...
    private static NonNullConsumer<Item> addTooltip(String... tooltip) {
        return i -> {
            if (FMLEnvironment.dist == Dist.CLIENT) {
                HyperionClient.TOOLTIPS.put(i, tooltip);
            }
        };
    }
}
